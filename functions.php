...
class StarterSite extends Timber\Site {
	...
	public function add_to_context( $context ) {
		...
		$context['options_f_website']  = get_fields('options')['f_website'];
		$context['options_f_payment']  = get_fields('options')['f_payment'];
		$context['options_main_menu']  = get_fields('options')['main_menu'];
...
function login_company_logo() { 
	?>
		<style type="text/css">
			body.login div#login h1 a {
				background-image: url("<?php echo get_fields('options')['logo_website']['url'] ?>") !important;
				width: 20.7rem;
				height: 4.8rem;
			...
			body.login  {
				...
				background-image: linear-gradient(106deg, rgb(10, 145, 107) 41%, rgb(255, 205, 0));
			}
	
		</style>
	<?php 
		} add_action( 'login_enqueue_scripts', 'login_company_logo' );
