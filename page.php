...
if( is_front_page()) {
    ...
    $context['options_comment_title']  = get_fields('options')['comment_title'];
    $context['options_jackpot']  = get_fields('options')['jackpot'];
    $context['options_jackpot_title']  = get_fields('options')['jackpot_title'];
